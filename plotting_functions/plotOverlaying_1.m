...
tempColorArray = {[0 32 96]./255,[0 176 240]./255,[255 0 0]./255,[102 0 0]./255};
...
for i = 1:2 %for raw and normalized trace
    ...
    setplotSpec_1(titleString,yUnitString,1.6,'Arial',13,10,xRange,yRange,timeRange);
    ...
    setplotSpec_1(titleString,yUnitString,1.6,'Arial',13,10,[0 timeRange],yRange,timeRange);
